...
Que el estudiante clasifique un activo financiero según su plazo, en mercado de dinero o de capitales.

## Contenido

|     | Tema                                          | Qué cubre                                                                 |
| --- | --------------------------------------------- | ------------------------------------------------------------------------- |
| I   | Mercado de dinero y mercado de capitales      | Plazo, función, emisores e instrumentos de cada mercado                   |
| II  | Agentes económicos y su acceso a los mercados | Cómo participa cada tipo de agente en el mercado de dinero y de capitales |
...
El mercado financiero se divide, por convención, según el plazo de los recursos que canaliza; es un criterio distinto de quién emite el instrumento (ver [`1_intermediacion_financiera.md`](1_intermediacion_financiera.md#2-dos-caminos-para-el-crédito)).
...
> **Ejemplo resuelto.** Clasificar un instrumento por plazo no depende de quién lo emite (ver [`3_emisor_activo_financiero.md`](3_emisor_activo_financiero.md)), son dos criterios independientes.
>
...
### 2. Agentes económicos y su acceso a los mercados
...
- Clasificar un instrumento por plazo (dinero/capitales) y por emisor (deuda directa/indirecta/capital) son dos criterios independientes: el plazo no dice nada sobre quién emite.
...
- Banxico usa el mercado de dinero como canal de política monetaria: sus operaciones de mercado abierto mueven la **TIIE**, la tasa de referencia de corto plazo de la economía.
