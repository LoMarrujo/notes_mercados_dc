...
| III | Fuentes y referencias                       | Bibliografía del curso                                         |
...
Mapa de quién regula, quién supervisa y quién protege dentro del sistema financiero mexicano.
...
**Tipos de relación en el organigrama:**

- Jerarquía / sectorización (SHCP)
- Coordinación entre autoridades autónomas
- Relación funcional (garantía, protección)
...
*Fuente: elaboración propia a partir de la organización oficial del Sistema Financiero Mexicano.*
...
- Portal CONDUSEF — Educación Financiera — material gráfico y casos reales de protección al usuario financiero.

---

## Cierre de la unidad — Lo esencial para recordar

- El SFM se organiza en tres niveles: **reguladores** (SHCP, Banxico) diseñan la política; **supervisores** (CNBV, CNSF, Consar) vigilan cada sector; **apoyo y protección** (IPAB, CONDUSEF) respaldan al usuario.
- **Banxico** es autónomo —no depende de la SHCP— y coordina con ella vía el **CESF**.
- La **CNBV** concentra la supervisión más amplia: banca, mercado de valores, Fintech, ahorro popular y auxiliares de crédito.
- **IPAB** y **CONDUSEF** se relacionan funcionalmente con los supervisores (p. ej., IPAB garantiza los depósitos que regula la CNBV).
