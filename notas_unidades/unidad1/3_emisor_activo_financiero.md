# Unidad 1 · Emisor del Activo Financiero

**Mercados de Deuda y Capitales**, Licenciatura en Comercio y Finanzas Internacionales, Universidad Autónoma de Zacatecas

## Objetivo de la unidad

Que el estudiante clasifique un activo financiero según quién lo emite: deuda directa, deuda indirecta o participación de capital.

## Contenido

|     | Tema                         | Qué cubre                                                                  |
| --- | ---------------------------- | -------------------------------------------------------------------------- |
| I   | Emisor del activo financiero | Deuda directa, deuda indirecta y participación de capital, según el emisor |

> La práctica de este tema está en [`practica_unidad1.md`](../../practicas/unidad1/practica_unidad1.md).

---

### 1. Emisor del activo financiero
...
| ------------------------ | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------- | -------- | -------- |
| Deuda directa            | El propio deudor final (empresa o gobierno) | El deudor que necesita los recursos coloca su propio título directamente con el inversionista, quien asume el riesgo de crédito frente a ese emisor, sin intermediario de por medio. | CETE, Bono gubernamental (Bono M, UDIBONO), Bono corporativo, Papel comercial, Certificado bursátil                          | Variable | Media    |
| Deuda indirecta          | Institución financiera (intermediario)      | El intermediario capta recursos emitiendo una obligación propia y es él (no el deudor final al que luego presta) quien asume el riesgo de crédito frente al inversionista.           | Pagarés bancarios, certificados de depósito, cuenta de ahorro / depósito a plazo, crédito hipotecario (visto desde el banco) | Bajo     | Alta     |
| Participación de capital | Empresa (acciones)                          | Título que representa una parte del capital de la empresa y da derecho a sus utilidades.                                                                                             | Acciones ordinarias y preferentes, FIBRAs, CKD, CERPI                                                                        | Alto     | Baja     |

Esta distinción es la misma que separa el **crédito directo** del **crédito indirecto** (intermediación bancaria) vista en [`1_intermediacion_financiera.md`](1_intermediacion_financiera.md#2-dos-caminos-para-el-crédito): lo que define a la deuda como directa o indirecta no es solo quién la emite formalmente, sino si ese emisor es el deudor final o un intermediario que se interpone y absorbe el riesgo por él.
...
> - *Certificado bursátil* emitido por una empresa. El nombre no adelanta el tipo: quien lo emite es la empresa directamente, sin un intermediario que se interponga, y promete pagar un monto pactado en la emisión → deuda directa, igual que un bono corporativo.

---

## Fuentes y referencias recomendadas

- Mántey de Anguiano, G. (2024). *Lecciones de Economía Monetaria*. UNAM. Lección 2: clasificación de activos financieros según el emisor.

---

## Cierre de la unidad — Lo esencial para recordar

- El activo financiero es **deuda directa**, **deuda indirecta** o **participación de capital**, según quién emite la obligación.
- Lo que separa deuda directa de indirecta no es solo quién firma formalmente, sino si ese emisor es el deudor final o un intermediario que absorbe el riesgo de crédito en su lugar.
- El *direct lending* (fondos que prestan directo a una empresa) sigue siendo deuda directa: el fondo es vehículo del inversionista, no un intermediario que absorbe el riesgo como lo haría un banco.
